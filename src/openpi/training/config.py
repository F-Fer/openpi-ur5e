...
_CONFIGS = [
    ...
    *roboarena_config.get_roboarena_configs(),
    ...
    TrainConfig(
        ...
        model=pi0_fast.Pi0FASTConfig(action_dim=7, action_horizon=16, max_token_len=160, paligemma_variant="gemma_2b_lora"),
        data=LeRobotUR5DataConfig(
            repo_id="F-Fer/ur-1",
            base_config=DataConfig(
                prompt_from_task=True,
        ...
        num_train_steps=5_000,
        freeze_filter=pi0_fast.Pi0FASTConfig(action_dim=7, action_horizon=16, max_token_len=160, paligemma_variant="gemma_2b_lora").get_freeze_filter(),
        ema_decay=None,
    ),
    TrainConfig(
        name="pi05_ur5e_lora",
